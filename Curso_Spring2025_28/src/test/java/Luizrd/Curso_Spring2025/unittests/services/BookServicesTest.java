package Luizrd.Curso_Spring2025.unittests.services;
...
import Luizrd.Curso_Spring2025.repository.BookRepository;
import Luizrd.Curso_Spring2025.services.BookServices;
import Luizrd.Curso_Spring2025.unittests.mapper.mocks.MockBook;
...
class BookServicesTest {
    ...
    void findAll() {
        ...
        List<BookDTO> book = new ArrayList<>();//service.findAll();
        ...
        assertNotNull(bookOne.getLinks().stream().anyMatch(
                link -> link.getRel().value().equals("self")
                        && link.getHref().endsWith("api/book/v1/1")
                        && link.getType().equals("GET")
        ));
        ...
        assertNotNull(bookFour.getLinks().stream().anyMatch(
                link -> link.getRel().value().equals("self")
