...
import Luizrd.Curso_Spring2025.controllers.PersonController;
import Luizrd.Curso_Spring2025.data.dto.PersonDTO;
import Luizrd.Curso_Spring2025.exception.BadRequestException;
import Luizrd.Curso_Spring2025.exception.FileStorageException;
import Luizrd.Curso_Spring2025.exception.RequiredObjectIsNullException;
import Luizrd.Curso_Spring2025.exception.ResourceNotFoundException;
...
import Luizrd.Curso_Spring2025.file.exporter.factory.FileExporterFactory;
import Luizrd.Curso_Spring2025.file.importer.contract.FileImporter;
import Luizrd.Curso_Spring2025.file.importer.factory.FileImporterFactory;
import Luizrd.Curso_Spring2025.model.Person;
import Luizrd.Curso_Spring2025.repository.PersonRepository;
...
public class PersonServices {
    ...
    public PagedModel<EntityModel<PersonDTO>> findAll(Pageable pageable) {
        ...
        return bluildPagedModel(pageable, people);
    }


    //FIND PEOPLE BY FIRSTNAME
    ...
    //PATCH????
    @Transactional
    public PersonDTO diseblePerson(Long id) {
    ...
    //Inclui o HAL E links HATEOAS
    private PagedModel<EntityModel<PersonDTO>> bluildPagedModel(Pageable pageable, Page<Person> people) {
