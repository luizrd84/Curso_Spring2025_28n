...
import Luizrd.Curso_Spring2025.exception.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public TokenDTO createAccessToken(String username, List<String> roles) {
        ...
        return new TokenDTO(username, true, now, validity,
    ...
    public Authentication getAuthentication(String token) {
        ...
        UserDetails userDetails = this.userDetailService.loadUserByUsername(
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new InvalidJwtAuthenticationException("Expired of Invalid JWT Token");
        }
    }
