...
public interface PersonControllerDocs {
    ...
    @Operation(summary = "Export Person data as PDF",
            description = "Export a specific Person data as PDF by yout ID",
            tags = {"People"}, responses = {
            @ApiResponse(description = "Success",
                responseCode = "200",
    ...
    //MASSIVE PEOPLE CREATION - IMPORTAR ARQUIVOS
    // @RequestMapping(   method = RequestMethod.GET, //Outro método
    ...
    // @RequestMapping(   method = RequestMethod.GET, //Outro método
    @Operation(summary = "Find People by Fist Name",
            description = "Find People by Fist Name",
            tags = {"People"}, responses = {
            @ApiResponse(description = "Success",
                    responseCode = "200",
                    content = {
